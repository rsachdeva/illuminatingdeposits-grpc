...
// InterestCalServiceClient is the sanitytestclient API for InterestCalService service.
//
...
func RegisterInterestCalServiceServer(s grpc.ServiceRegistrar, srv InterestCalServiceServer) {
	s.RegisterService(&_InterestCalService_serviceDesc, srv)
}
...
var _InterestCalService_serviceDesc = grpc.ServiceDesc{
